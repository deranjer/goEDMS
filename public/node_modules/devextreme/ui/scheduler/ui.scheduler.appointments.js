...
var SchedulerAppointments = _uiCollection_widget2.default.inherit({
    ...
    _createItemByTemplate: function(itemTemplate, renderArgs) {
        ...
        var recurrenceRule = this.invoke("getField", "recurrenceRule", itemData);
        return itemTemplate.render({
            model: {
                appointmentData: itemData,
                targetedAppointmentData: this.invoke("getTargetedAppointmentData", itemData, (0, _renderer2.default)(container).parent(), !!recurrenceRule)
            },
            container: container,
            index: index
        })
