...
! function(factory) {
    ...
    var _enableAlternateTemplateTags = true;
    ...
    function createTemplateCompiler() {
        ...
        return function(text) {
            var bag = ["var _ = [];", "with(obj||{}) {"],
                chunks = text.split(_enableAlternateTemplateTags ? EXTENDED_OPEN_TAG : OPEN_TAG);
            acceptText(bag, chunks.shift());
            for (var i = 0; i < chunks.length; i++) {
                var tmp = chunks[i].split(_enableAlternateTemplateTags ? EXTENDED_CLOSE_TAG : CLOSE_TAG);
                if (2 !== tmp.length) {
    ...
    return {
        ...
        enableAlternateTemplateTags: function(value) {
            _enableAlternateTemplateTags = value
        },
